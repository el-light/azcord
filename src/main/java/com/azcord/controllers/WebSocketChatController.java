...
public class WebSocketChatController {
    ...
    private void sendErrorMessageToUser(String sessionId, String errorDetails) {
        ...
        // The SimpMessageHeaderAccessor in the main methods provides the session ID.
        // The Principal object is usually populated after successful handshake.
        // If principal is null (e.g. handshake failed or token issue), we use sessionId.
        // However, @SendToUser works best when the Principal is established.
        // For unauthenticated errors before principal is set, direct messaging by session ID is harder without custom setup.
        // The @MessageExceptionHandler with @SendToUser is the primary way for errors *after* principal is known.
        // For pre-auth errors, usually the connection is just dropped by the interceptor.
